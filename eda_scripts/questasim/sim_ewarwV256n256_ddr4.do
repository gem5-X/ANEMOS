...
vlog -work work -stats=none ${EDA_PROJECT_ROOT}/HDL/GATE/imc_C32R8S4_DDR4_generic.v
scgenmod imc_core > ../C_FILES/imc_wrapped_S4.h

# Compile for DDR4
project compileall
vlog -work work -vopt -stats=none +acc=np ${EDA_PROJECT_ROOT}/HDL/GATE/imc_C32R8S4_DDR4_generic.v
...
vcd file ${VCD_FILES}/imc_C32R8S4_ewarwV256n256_DDR4.vcd.gz
