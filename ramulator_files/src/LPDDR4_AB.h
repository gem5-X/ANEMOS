#ifndef __LPDDR4_AB_H
#define __LPDDR4_AB_H
...
public:
    ...
    enum class Org;
    enum class Speed;
    LPDDR4_AB(Org org, Speed speed);
    LPDDR4_AB(const string& org_str, const string& speed_str);
    ...
    /* Prerequisite */
    function<Command(DRAM<LPDDR4_AB>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<LPDDR4_AB>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<LPDDR4_AB>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<LPDDR4_AB>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];
    ...
    struct SpeedEntry {
        ...
        {3200, 400,     2.5,   2, 2, 1, 1,    8,  8,    7,    8,    5, 17, 24,    4,  4,    7, 1,  4, 16, 0, 0, 0, 0,  3,  6, 0}
    }, speed_entry;
