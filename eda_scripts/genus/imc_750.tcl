...
set_units -time ps
create_clock -name clk_src -period 1333 [get_db ports *clk]
...
# Add the vcd file
#read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/imc_750.vcd

report_area > RPT/imc_area_750tt.rep
report_timing > RPT/imc_timing_750tt.rep
#report_power -by_hierarchy > RPT/imc_power_750tt.rep

write_hdl -generic > HDL/GATE/imc_generic750.v
write_sdf > TIM/imc_clk1ns33.sdf

write_design -base_name TEMP/imc_750
