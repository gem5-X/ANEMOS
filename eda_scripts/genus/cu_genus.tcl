...
report_area > RPT/cu_area_ss.rep
report_timing > RPT/cu_timing_ss.rep
...
syn_map
syn_opt
report_area > RPT/cu_area_ff.rep
report_timing > RPT/cu_timing_ff.rep

set_db library tcbn28hpmbwp35tt0p9v25c.lib
syn_gen
syn_map
syn_opt
report_area > RPT/cu_area_tt.rep
report_timing > RPT/cu_timing_tt.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/cu_generic.v
write_sdf > TIM/cu_clk3ns.sdf
