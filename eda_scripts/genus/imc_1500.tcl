...
set_units -time ps
create_clock -name clk_src -period 667 [get_db ports *clk]
external_delay -input 50 [all_inputs]
external_delay -output 50 [all_outputs]
...
# Add the vcd file
read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/imc_1500.vcd

report_area > RPT/imc_area_1500tt.rep
report_timing > RPT/imc_timing_1500tt.rep
report_power -by_hierarchy > RPT/imc_power_1500tt.rep

write_hdl -generic > HDL/GATE/imc_generic1500.v
write_sdf > TIM/imc_clk0ns67.sdf

write_design -base_name TEMP/imc_1500
