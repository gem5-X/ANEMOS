...
set_units -time ps
create_clock -name clk_src -period 500 [get_db ports *clk]
...
# Add the vcd file
#read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/imc_2000.vcd

report_area > RPT/imc_area_2000tt.rep
report_timing > RPT/imc_timing_2000tt.rep
#report_power -by_hierarchy > RPT/imc_power_2000tt.rep

write_hdl -generic > HDL/GATE/imc_generic2000.v
write_sdf > TIM/imc_clk0ns5.sdf

write_design -base_name TEMP/imc_2000
