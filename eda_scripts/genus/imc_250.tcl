...
set_units -time ps
create_clock -name clk_src -period 4000 [get_db ports *clk]
...
# Add the vcd file
#read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/imc_250.vcd

report_area > RPT/imc_area_250tt.rep
report_timing > RPT/imc_timing_250tt.rep
#report_power -by_hierarchy > RPT/imc_power_250tt.rep

write_hdl -generic > HDL/GATE/imc_generic250.v
write_sdf > TIM/imc_clk4ns.sdf

write_design -base_name TEMP/imc_250
