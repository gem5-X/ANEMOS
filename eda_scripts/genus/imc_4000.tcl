...
set_units -time ps
create_clock -name clk_src -period 250 [get_db ports *clk]
external_delay -input 25 [all_inputs]
...
report_area > RPT/imc_area_4000tt.rep
report_timing > RPT/imc_timing_4000tt.rep
#report_power -by_hierarchy > RPT/imc_power_4000tt.rep

write_hdl -generic > HDL/GATE/imc_generic4000.v
write_sdf > TIM/imc_clk0ns25.sdf

write_design -base_name TEMP/imc_4000
