...
public:
    ...
    enum class Org;
    enum class Speed;
    GDDR5_AB(Org org, Speed speed);
    GDDR5_AB(const string& org_str, const string& speed_str);
    ...
    /* Prerequisite */
    function<Command(DRAM<GDDR5_AB>*, Command cmd, int)> prereq[int(Level::MAX)][int(Command::MAX)];

    // SAUGATA: added function object container for row hit status
    /* Row hit */
    function<bool(DRAM<GDDR5_AB>*, Command cmd, int)> rowhit[int(Level::MAX)][int(Command::MAX)];
    function<bool(DRAM<GDDR5_AB>*, Command cmd, int)> rowopen[int(Level::MAX)][int(Command::MAX)];
    ...
    /* Lambda */
    function<void(DRAM<GDDR5_AB>*, int)> lambda[int(Level::MAX)][int(Command::MAX)];
    ...
    struct SpeedEntry {
        ...
        {600,  300,      3.333,  2, 2, 3, 5,  5,  4,  5,  3, 12, 17, 1, 2, 3, 4,   5,  4,  28, 0, 0, 10, 10, 0, 0, 0, 0}
    }, speed_entry;
