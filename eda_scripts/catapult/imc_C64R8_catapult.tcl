...
directive set /imc_core/rf_twoport<cnm_synth,8U>/write_update_thread/for -UNROLL yes
...
directive set /imc_core/rf_threeport<cnm_synth,8U>/write_update_thread/for -UNROLL yes
