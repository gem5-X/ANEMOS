...
read_hdl imc_C32R8S16_LPDDR4.v
...
create_clock -name clk_src -period 5000 [get_db ports *clk]
...
report_area -physical > RPT/area/imc_C32R8S16_LPDDR4.rep
report_timing > RPT/timing/imc_C32R8S16_LPDDR4.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/imc_C32R8S16_LPDDR4_generic.v
write_sdf > TIM/imc_C32R8S16_LPDDR4.sdf

write_db -to_file designs/imc_C32R8S16_LPDDR4.db -all_root_attributes
