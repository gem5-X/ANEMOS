...
directive set /imc_core/rf_twoport<ac_ieee_float16,8U>/write_update_thread/for -UNROLL yes
...
directive set /imc_core/rf_threeport<ac_ieee_float16,8U>/write_update_thread/for -UNROLL yes
directive set /imc_core/rf_twoport<uint32_t,32U>/write_update_thread/for -UNROLL yes
