...
report_area -physical > RPT/area/imc_C32R8S16_GDDR5.rep
report_timing > RPT/timing/imc_C32R8S16_GDDR5.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/imc_C32R8S16_GDDR5_generic.v
write_sdf > TIM/imc_C32R8S16_GDDR5.sdf

write_db -to_file designs/imc_C32R8S16_GDDR5.db -all_root_attributes
