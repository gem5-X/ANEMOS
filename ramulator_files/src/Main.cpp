...
int main(int argc, const char *argv[])
{
    ...
    } else if (standard == "DDR4_AB") {
      DDR4_AB* ddr4 = new DDR4_AB(configs["org"], configs["speed"]);
      start_run(configs, ddr4, files);
    ...
    } else if (standard == "LPDDR4_AB") {
      // total cap: 2GB, 1/2 of others
      LPDDR4_AB* lpddr4 = new LPDDR4_AB(configs["org"], configs["speed"]);
      start_run(configs, lpddr4, files);
    } else if (standard == "GDDR5") {
      GDDR5* gddr5 = new GDDR5(configs["org"], configs["speed"]);
      start_run(configs, gddr5, files);
    } else if (standard == "GDDR5_AB") {
      GDDR5_AB* gddr5 = new GDDR5_AB(configs["org"], configs["speed"]);
      start_run(configs, gddr5, files);
    } else if (standard == "HBM") {
      HBM* hbm = new HBM(configs["org"], configs["speed"]);
      start_run(configs, hbm, files);
    } else if (standard == "HBM_AB") {
      HBM_AB* hbm = new HBM_AB(configs["org"], configs["speed"]);
      start_run(configs, hbm, files);
    } else if (standard == "HBM2") {
      HBM2* hbm2 = new HBM2(configs["org"], configs["speed"]);
      start_run(configs, hbm2, files);
    } else if (standard == "HBM2_AB") {
      HBM2_AB* hbm2 = new HBM2_AB(configs["org"], configs["speed"]);
      start_run(configs, hbm2, files);
