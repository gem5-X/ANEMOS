...
report_area -physical > RPT/area/imc_C32R8S16_1pch.rep
report_timing > RPT/timing/imc_C32R8S16_1pch.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/imc_C32R8S16_1pch_generic.v
write_sdf > TIM/imc_C32R8S16_1pch.sdf

write_db -to_file designs/imc_C32R8S16_1pch.db -all_root_attributes

# Power analysis
#read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/VCD/pch_C32R8S16_dpV100n100.vcd -vcd_scope /top/IMCcoreUnderTest_0
