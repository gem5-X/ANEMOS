...
template <>
bool Controller<HBM_AB>::enqueue(Request& req)
{
    return enqueue_AB(req);
}

template <>
bool Controller<HBM2_AB>::enqueue(Request& req)
{
    return enqueue_AB(req);
}

template <>
bool Controller<DDR4_AB>::enqueue(Request& req)
{
    return enqueue_AB(req);
}

template <>
bool Controller<LPDDR4_AB>::enqueue(Request& req)
{
    return enqueue_AB(req);
}
...
template <>
void Controller<HBM2_AB>::tick(){
    tick_AB();
}

template <>
void Controller<DDR4_AB>::tick(){
    tick_AB();
}

template <>
void Controller<LPDDR4_AB>::tick(){
    tick_AB();
}
