...
report_area -physical > RPT/area/imc_C32R8S8_HBM.rep
report_timing > RPT/timing/imc_C32R8S8_HBM.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/imc_C32R8S8_HBM_generic.v
write_sdf > TIM/imc_C32R8S8_HBM.sdf

write_db -to_file designs/imc_C32R8S8_HBM.db -all_root_attributes
