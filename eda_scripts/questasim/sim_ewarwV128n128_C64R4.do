...
# Generate wrapper
vlog -work work -stats=none ${EDA_PROJECT_ROOT}/HDL/GATE/imc_C64R4S16_1pch_generic.v
scgenmod imc_core > imc_wrapped_S16.h

# Compile for C64R4
project compileall
vlog -work work -vopt -stats=none +acc=np ${EDA_PROJECT_ROOT}/HDL/GATE/imc_C64R4S16_1pch_generic.v
...
vcd file ${VCD_FILES}/hbmCR/imc_C64R4S16_ewarwV128n128_HBM.vcd.gz
