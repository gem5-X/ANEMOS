...
set_db library {tcbn28hpmbwp35tt0p9v25c.lib tcbn28hpmbwp35ss0p81v125c.lib tcbn28hpmbwp35ff0p99v0c.lib}
read_hdl imc_core.v
...
report_area > RPT/imc_area_300.rep
report_timing > RPT/imc_timing_300.rep

# Write the netlist and the timing SDF
write_hdl -generic > HDL/GATE/imc_generic.v
write_sdf > TIM/imc_clk3ns.sdf
