...
directive set /imc_core/rf_twoport<cnm_synth,16U>/write_update_thread/for -UNROLL yes
...
directive set /imc_core/rf_threeport<cnm_synth,16U>/write_update_thread/for -UNROLL yes
directive set /imc_core/rf_twoport<uint32_t,16U>/write_update_thread/for -UNROLL yes
