...
set_units -time ps
create_clock -name clk_src -period 2000 [get_db ports *clk]
...
# Add the vcd file
#read_vcd /home/rmedina/shares/local/scrap/pim_cores/MGC_QSIM/OUT/imc_500.vcd

report_area > RPT/imc_area_500tt.rep
report_timing > RPT/imc_timing_500tt.rep
#report_power -by_hierarchy > RPT/imc_power_500tt.rep

write_hdl -generic > HDL/GATE/imc_generic500.v
write_sdf > TIM/imc_clk2ns.sdf

write_design -base_name TEMP/imc_500
